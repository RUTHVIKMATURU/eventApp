  ...
  return (
    <div>
      <nav className='navbar d-flex justify-content-between bg-dark p-2'>
        <Link to="/">
        <img src="https://img.freepik.com/free-vector/colorful-bird-illustration-gradient_343694-1741.jpg?t=st=1740913289~exp=1740916889~hmac=1c77cd781505437de6b78cf13b6db6859c083a45b4ced91d80d980cd1353834d&w=1060" alt="" width="50px" className='rounded-circle'/>
        </Link>
